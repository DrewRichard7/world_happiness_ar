# Fish and seafood consumption per capita - Data package

This data package contains the data that powers the chart ["Fish and seafood consumption per capita"](https://ourworldindata.org/grapher/fish-and-seafood-consumption-per-capita?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website. It was downloaded on January 30, 2025.
