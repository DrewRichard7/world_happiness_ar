    ...
    if (active_view() == "comparative") {
      tagList(
        ...
        radioButtons(
          ...
          choices = c(
            "Fish Consumed" = "fish_kg_per_person_per_year",
            "Sugar Consumed" = "sugar_g_per_person_per_day"
          ),
          selected = "fish_kg_per_person_per_year"
        ) # Default to Fish
      )
      ...
      p <- ggplot(
        ...
        aes(
          ...
          text = paste(
            "Year:", year,
            "\nCountry:", country,
            "\n", y_axis_label(), ":", round(happy_sad_y_val(), 2),
            "\n", ifelse(x_var == "fish_kg_per_person_per_year",
              "Fish Consumed (kg/person/year)",
              "Sugar Consumed (g/person/day)"
            ), ":",
        ...
        labs(
          title = glue(
            "{y_axis_label() } v {ifelse(x_var == 'fish_kg_per_person_per_year',
